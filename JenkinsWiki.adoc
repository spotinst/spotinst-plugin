...
* AWS stateful groups: deallocate stateful instances when removed from Jenkins
* Fixed UI bug: monitor alert won't show up for Spotinst Clouds Communication Monitor when all groups are properly connected
